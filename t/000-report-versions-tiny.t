...
eval { $v .= pmver('Dist::Zilla::Plugin::Test::DistManifest','2.0.1') };
eval { $v .= pmver('Dist::Zilla::Plugin::Test::Kwalitee','any version') };
eval { $v .= pmver('Dist::Zilla::Plugin::Test::MinimumVersion','2.0.1') };
eval { $v .= pmver('Dist::Zilla::Plugin::Test::Perl::Critic','2.112410') };
eval { $v .= pmver('Dist::Zilla::Plugin::Test::Portability','2.0.1') };
eval { $v .= pmver('Dist::Zilla::Plugin::Test::Synopsis','2.0.1') };
eval { $v .= pmver('Dist::Zilla::Plugin::Test::UnusedVars','2.0.1') };
